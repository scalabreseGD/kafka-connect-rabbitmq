...
class RabbitMQConnectorConfig extends AbstractConfig {
    private static final String RABBITMQ_PREFX = "rabbitmq.";
    public static final String USERNAME_CONFIG = RABBITMQ_PREFX + "username";
    public static final String PASSWORD_CONFIG = RABBITMQ_PREFX + "password";
    public static final String VIRTUAL_HOST_CONFIG = RABBITMQ_PREFX + "virtual.host";
    public static final String REQUESTED_CHANNEL_MAX_CONFIG = RABBITMQ_PREFX + "requested.channel.max";
    public static final String REQUESTED_FRAME_MAX_CONFIG = RABBITMQ_PREFX + "requested.frame.max";
    public static final String CONNECTION_TIMEOUT_CONFIG = RABBITMQ_PREFX + "connection.timeout.ms";
    public static final String HANDSHAKE_TIMEOUT_CONFIG = RABBITMQ_PREFX + "handshake.timeout.ms";
    public static final String SHUTDOWN_TIMEOUT_CONFIG = RABBITMQ_PREFX + "shutdown.timeout.ms";
    public static final String REQUESTED_HEARTBEAT_CONFIG = RABBITMQ_PREFX + "requested.heartbeat.seconds";
    public static final String AUTOMATIC_RECOVERY_ENABLED_CONFIG = RABBITMQ_PREFX + "automatic.recovery.enabled";
    public static final String TOPOLOGY_RECOVERY_ENABLED_CONFIG = RABBITMQ_PREFX + "topology.recovery.enabled";
    public static final String NETWORK_RECOVERY_INTERVAL_CONFIG = RABBITMQ_PREFX + "network.recovery.interval.ms";
